...
def read_crowdflower_full_export(datasets):
  df_all=pd.DataFrame()
  for dataset in datasets:
    ...
    for file in dataset["files"]:
      print file
      df_full=pd.read_csv(file, delimiter=",", quoting=csv.QUOTE_ALL,index_col=False,dtype={"r1id":"str","r2id":"str"},usecols=["r1id","r2id","r1","r2","which_of_the_rules_do_you_find_as_more_plausible"])
